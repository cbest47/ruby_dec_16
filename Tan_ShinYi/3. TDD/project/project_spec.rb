...
RSpec.describe Project do
  ...
  it 'has a method elevator_pitch to explain name and description' do
   ...
   it 'has a method add_team_member to add a new member' do
     project = Project.new("Project", "Change the World!")
     expect(project.add_team_member('Alice')).to eq("New team member Alice has been added.")
   end
