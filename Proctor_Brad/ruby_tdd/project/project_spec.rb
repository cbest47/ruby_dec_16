...
RSpec.describe Project do
  ...
  it 'has a getter and setter for name attribute' do
      project = Project.new("Project Name", "I am a project")
      project.description = "Changed the description"

      expect(project.description).to eq("Changed the description")
  end
  ...
  it 'has a method that adds 1 to team_members' do
      project = Project.new("Project 3", "description 3")

      expect(project.add_to_team).to eq(1)
  end
end
