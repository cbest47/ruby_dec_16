...
mine.withdraw_money("checking", 100)
mine.withdraw_money("savings", 50)
mine.deposit_money("savings", 500)
mine.account_information
yours = BankAccount.new
yours.display_checking_balance
yours.number_of_accounts